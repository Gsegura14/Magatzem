<div>
    <div>
        ...
        <div class="card">
            <div class="card-body">
            <input type='hidden' name="pedido_id" id="pedido_id" wire:model="cabecera">
                    <div class="row">
                    <div class="col-sm-12 col-md-3 col-lg-4">
                        <div class="form-group" wire:ignore>
                            <label>Modelo :</label>
                            <select class="form-control select2" wire:model="selectedModelo">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <x-jet-button class="col-md-3 mt-4 btn btn-primary float-right mt-4 btn-block" wire:click="insertarLineaNueva({{$cabecera->id}})" id="btnInsertar">Añadir</x-jet-button>
                    </div>
                </div>
