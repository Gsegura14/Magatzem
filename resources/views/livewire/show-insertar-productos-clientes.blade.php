<div>
    <div>
        ...
        <div class="card">
            <div class="card-body">
            <input type='hidden' name="pedido_id" id="pedido_id" wire:model="pedido">
                    <div class="row">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <x-jet-button class="col-md-3 mt-4 btn btn-primary float-right mt-4 btn-block" wire:click="insertarLineaNueva({{$pedido->id}})" id="btnInsertar">Añadir</x-jet-button>
                    </div>
                </div>
