...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-4 mb-2">
            <a href="{{ route('pedidosClientes.pdf') }}">
                <x-adminlte-button class="float-right mr-2 mt-2" theme="danger" id="btnPdf" icon="fa fa-download" />
            </a>
            <a href="{{ route('admin') }}">
                <x-adminlte-button class="float-right mr-2 mt-2" theme="danger" label="Inicio" id="btnInicio" />
            </a>
                            ...
                            <td>
                                <ul class="list-group list-group-horizontal float-right">
                                    <li class="border-0 mr-4">
                                        <form action="{{ route('pedidoCliente.show', $pedido) }}" method="GET">
                                            <x-adminlte-button type="submit" theme="primary" icon="fas fa-eye" />
                                            @csrf
                                        </form>
                                    </li>
                                    <li class="border-0 pd-0 mr-4">
                                        <form action="{{ route('pedidoCliente.destroy', $pedido) }}" method="POST">
